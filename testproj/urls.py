...
urlpatterns = [
    ...
    url(r'^testapp/(?P<pk>\d+)/$', views.TopicListView.as_view(), name='board_topics'),
    url(r'^testapp/(?P<pk>\d+)/new/$', views.new_topic, name='new_topic'),
    ...
    url(r'^testapp/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/$',views.PostListView.as_view(), name='topic_posts'),
    url(r'^testapp/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/reply/$', views.reply_topic, name='reply_topic'),
    url(r'^testapp/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/posts/(?P<post_pk>\d+)/edit/$',
